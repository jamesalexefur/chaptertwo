    ...
    <>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-[0.9rem] sm:text-[1rem] text-[#4A4A4A] mb-8 sm:mb-12">
            Call us at <a href="tel:1-800-555-0192" className="text-[#B5294E] hover:underline font-medium">1-800-555-0192</a> if you don't see yours.
          </p>
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <CTAButton variant="ghost" href="tel:1-800-555-0192">
